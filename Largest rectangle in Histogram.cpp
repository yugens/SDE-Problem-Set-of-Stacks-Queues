//Optimised approach using stack , maintain left and right limit bar for each rectangle using stack and store them in seperate arrays . Calculate area for
//each rectangle and return maximum among them .
//T.C.- o(n) and space compexity o(n)
